...
public class SQLiteHelper extends SQLiteOpenHelper {
        ...
        private String mDummydata[][] = { { "t3n News", "http://t3n.de/news/feed" },
        ...
        private static final String FEED_TABLE_CREATE = "CREATE TABLE " + FEED_TABLE_NAME + " (" + FEED_TABLE_COLUMN_ID
                        + " integer primary key autoincrement, " + FEED_TABLE_COLUMN_NAME + " TEXT, " + FEED_TABLE_COLUMN_URL + " TEXT);";
        ...
        public void onCreate(SQLiteDatabase database) {
                ...
                for (String[] mData : mDummydata) {
                        ...
                        mValues.put(SQLiteHelper.FEED_TABLE_COLUMN_NAME, mData[0]);
                        mValues.put(SQLiteHelper.FEED_TABLE_COLUMN_URL, mData[1]);

                        database.insert(SQLiteHelper.FEED_TABLE_NAME, null, mValues);
                }
        }
